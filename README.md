...
| `tables`          | Comma separate list of table names in the snowflake schema. If you pass `"*"`, the connector will pull from all tables in the schema.                                                                                                                                                                                                                 | yes      | "users,orders"                                                |
| `columns`        | mapping of column names per table that should be included in each the respective table's Record payloads. By default: all columns from all tables.                                                                                                                                 | no       | "id,name,age"                                          |
