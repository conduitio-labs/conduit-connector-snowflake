...
type DestinationConfig struct {
	...
	config.Config
	// MaxBatchSize is the max number of records the batcher processes before pushing to snowflake
	MaxBatchSize int
	// MaxFileSize is the max number of bytes the batcher processes before pushing to snowflake
	MaxFileSize int
	// BatchIntervalTime is the interval of time between the batcher pushing to snowflake in milliseconds
	BatchIntervalTime int
}
